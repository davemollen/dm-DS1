...
impl Coefficients for Vec<f32x4> {
  fn new() -> Self {
    vec![
      f32x4::from_array([0.01125185, 0.03865128, 0.08504667, 0.14398426]),
      f32x4::from_array([0.19927209, 0.22988362, 0.2192143, 0.16427033]),
      f32x4::from_array([0.07945002, -0.00808101, -0.06986703, -0.08885826]),
      f32x4::from_array([-0.06665865, -0.02149577, 0.02178898, 0.04408222]),
      f32x4::from_array([0.04005594, 0.01816779, -0.00633178, -0.02061061]),
      f32x4::from_array([-0.02034176, -0.00992074, 0.00212385, 0.00889396]),
      f32x4::from_array([0.0084963, 0.00365514, -0.00127734, -0.00340804]),
      f32x4::from_array([-0.00257378, -0.00051301, 0.00091173, 0.00099469]),
    ]
  }
}
...
impl Coefficients for Vec<f32x8> {
  fn new() -> Self {
    vec![
      f32x8::from_array([
        0.00530431, 0.01292807, 0.02477923, 0.0407737, 0.06007363, 0.08098469, 0.10111713,
        0.11773028,
      ]),
      f32x8::from_array([
        0.1282148, 0.13060134, 0.12398595, 0.10877266, 0.0866628, 0.06038885, 0.03323685,
        0.00845986,
      ]),
      f32x8::from_array([
        -0.01127786,
...
impl Coefficients for Vec<f32x16> {
  fn new() -> Self {
    vec![
      f32x16::from_array([
        0.00307051, 0.00595493, 0.01019564, 0.01574976, 0.02254972, 0.03040179, 0.03898418,
        0.04786567, 0.05652942, 0.06442298, 0.07100153, 0.07578451, 0.07839931, 0.0786228,
        0.07640344, 0.07187152,
      ]),
      f32x16::from_array([
        0.06532661,
        0.05721073,
