...
A distortion effect written in Rust modeled after the classic Boss DS-1.
...
However, you can download the latest MOD Dwarf build from the [releases page](https://github.com/davemollen/dm-DS1/releases).
